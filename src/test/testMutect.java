...
import snu.bike.wholeExomSeq.mutect.MutectExecutor;

public class testMutect {
...
//			 * */
			 ...
			 * mutect
			 * */
			MutectExecutor mutect = new MutectExecutor(cli.getExecutionPath(),cli.getReferenceSequence(), cli.getCosmicFile(), cli.getSnpFile(), outputFile_gatk_recali_normal, outputFile_gatk_recali_tumor);
			mutect.excute();
